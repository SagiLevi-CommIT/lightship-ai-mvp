...
CURRENT_ADDITIONAL_ALLOWED_CIDR_2="$(normalize_param "$(describe_param AdditionalAllowedAlbIngressCidr2)")"
CURRENT_ADDITIONAL_ALLOWED_CIDR_3="$(normalize_param "$(describe_param AdditionalAllowedAlbIngressCidr3)")"
...
ADDITIONAL_ALLOWED_ALB_INGRESS_CIDR_2="${ADDITIONAL_ALLOWED_ALB_INGRESS_CIDR_2:-$CURRENT_ADDITIONAL_ALLOWED_CIDR_2}"
ADDITIONAL_ALLOWED_ALB_INGRESS_CIDR_3="${ADDITIONAL_ALLOWED_ALB_INGRESS_CIDR_3:-$CURRENT_ADDITIONAL_ALLOWED_CIDR_3}"
...
params=(
  ...
  "AdditionalAllowedAlbIngressCidr2=${ADDITIONAL_ALLOWED_ALB_INGRESS_CIDR_2}"
  "AdditionalAllowedAlbIngressCidr3=${ADDITIONAL_ALLOWED_ALB_INGRESS_CIDR_3}"
