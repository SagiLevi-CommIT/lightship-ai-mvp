...
- **Weather-aware detection**: Maintain or improve detection performance under rainy/adverse conditions vs PoC baseline.
...
- Deployable to both Commit AI-POC AWS account and client's own AWS account via documented scripts.
